...
4. The last simplification is that the name of imported items always starts with the keyword ```imported```. This heuristic is hard coded in the class [ImportedItemsTaxation](src/info/rporrini/saleTaxes/ImportedItemsTaxation.java). The code is designed to be open to new and different criteria.
